...
const whitelist = new Set(['U00123', 'U00456', 'U00789', 'U00999', 'U00042']);
const revoked = new Set();
const bannedUntil = new Map();
const sessions = new Map();

function isWhitelisted(u00) {
  return whitelist.has(u00);
}
...
module.exports = {
  ...
  listSessions,
  setFrozen,
  _internal: { whitelist, revoked, sessions, bannedUntil }
};
